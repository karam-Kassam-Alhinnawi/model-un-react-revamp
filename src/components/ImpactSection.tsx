...
const ImpactSection = () => {
  return (
    <section className="relative py-24 bg-card overflow-hidden">
      {/* Decorative elements */}
      <DiplomaticStar className="absolute right-10 top-10 w-32 h-32 text-primary" />
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          <div className="relative group">
            ...
            {/* Decorative border */}
            <div className="absolute -inset-3 rounded-2xl border border-primary/10 -z-10 group-hover:border-primary/20 transition-colors" />
          </div>
        </motion.div>
