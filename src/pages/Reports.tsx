      ...
      <section className="pt-32 pb-24 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }}>
            <img src={impactCover} alt="2025 Impact Report" className="rounded-2xl shadow-elevated w-full max-w-md mx-auto" />
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
            ...
            <img src={founderLetter} alt="Letter from Founder" className="rounded-xl shadow-card mb-8 w-full max-w-sm" />
            <a
